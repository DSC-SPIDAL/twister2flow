...
class PythonTask(Task):
    ...
    def set_exec_path(self, exec_path):
        self.__python_exec_path = exec_path

    def get_exec_path(self):
        return self.__python_exec_path

    def execute(self):
        print("Executing Python Task: " + self.get_command() + " " + self.get_script_path())
