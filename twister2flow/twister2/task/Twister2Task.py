...
class Twister2Task(Task):
    __script_path = None
    __command = None
    __twister2_exec_path = None
    ...
    def set_command(self, command=None):
        if command is None:
            self.__command = "twister2 submit standalone python"
        else:
    ...
    def set_exec_path(self, exec_path):
        self.__twister2_exec_path = exec_path

    def get_exec_path(self):
        return self.__twister2_exec_path

    def execute(self):
        print("Executing Twister2 Task: " + self.get_command() + " " + self.get_script_path())
    ...
    def __str__(self):
        ...
        task_description += "\t\tExecution Path: \t{} \n".format(self.__twister2_exec_path)
